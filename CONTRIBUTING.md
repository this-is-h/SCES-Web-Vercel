...
- `public/updates/latest.json` 由 `sces-management` 的 release CI **跨仓推送**到本仓库 main（自动化，勿手改）；
- `public/download.html` 指向 sces-management 的 GitHub Release 安装包（版本带 `profileId`）。
